...
namespace Live0xUtils.QRCodeUtils
{
    public abstract class QRCodeHelper
    {
        ...
        /// <returns>位图</returns>
        public static Bitmap CreateCode(string msg, int version, int pixel, string icon_path, int icon_size, int icon_border, bool white_edge)
        {
